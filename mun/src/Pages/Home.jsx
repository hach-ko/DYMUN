...
export default function Home() {
  ...
  // Custom styles for committee buttons
  const committeeBtn =
  ...
  return (
    <Layout currentPageName="Home">
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 w-full px-6 py-12">
        {/* Hero Section */}
        {isLoading ? (
          <section className="px-6 pt-12 pb-24 max-w-7xl mx-auto">
            <div className="text-center">
              <Skeleton className="h-12 w-3/4 mx-auto mb-6 animate-pulse" />
              <Skeleton className="h-6 w-1/2 mx-auto mb-10 animate-pulse" />
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8">
                ...
                <div className="flex items-center gap-2 text-slate-700">
                  <svg
                    ...
                    width="24"
                    height="24"
                    className="w-6 h-6 text-amber-500 hidden sm:inline-flex"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                  ...
                  <span className="font-semibold text-lg inline-flex">Two-day immersive experience</span>
                </div>
              </div>
              <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
        ...
        <section className="px-6 py-20 max-w-6xl mx-auto">
          {isLoading ? (
            <div className="text-center">
              <Skeleton className="h-12 w-1/2 mx-auto mb-6 animate-pulse" />
              <Skeleton className="h-6 w-3/4 mx-auto mb-10 animate-pulse" />
              <div className="space-y-12">
                {Array(3).fill(0).map((_, i) => (
                  <div key={i}>
                    <Skeleton className="h-8 w-1/3 mb-6 mx-auto animate-pulse" />
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                      {Array(3).fill(0).map((_, j) => (
                        <Skeleton key={j} className="h-64 w-full rounded-xl animate-pulse" />
                      ))}
                    </div>
                  </div>
                ))}
            ...
            <div className="text-center">
              <h2 className="text-5xl font-bold text-slate-900 mb-6 animate-fadeSlideUp" data-index="0">
                Available Committees
              </h2>
              <p className="text-xl text-slate-600 mb-10 max-w-3xl mx-auto animate-fadeSlideUp" data-index="1" style={{ animationDelay: "100ms" }}>
                    ...
                    {group.committees.map((c, index) => (
                      ...
                      >
                        <div
                          ...
                          className="rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 bg-white/90 backdrop-blur-sm group hover:-translate-y-1 flex flex-col justify-between cursor-pointer"
        ...
        <section className="px-6 py-20 bg-white/60 backdrop-blur-md select-none">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-5xl font-bold text-center text-slate-900 mb-6">Why Join DYMUN?</h2>
            <p className="text-xl text-center text-slate-600 mb-12 max-w-4xl mx-auto">
              Experience the thrill of international diplomacy while building lifelong skills and friendships across all educational levels
            </p>
            {isLoading ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {Array(3).fill(0).map((_, i) => (
                  <Skeleton key={i} className="h-64 w-full rounded-lg animate-pulse" />
                ))}
              </div>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={card.title} className="min-w-0">
                    <div className={`rounded-lg border border-blue-200 text-card-foreground shadow-xl transition-all duration-300 h-full bg-white/90 backdrop-blur-sm group hover:-translate-y-2 hover:shadow-2xl p-6`}>
                      <div className="flex flex-col space-y-1.5 text-center pb-6">
        ...
        {isLoading ? (
          <section className="px-6 py-24 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 relative overflow-hidden rounded-t-3xl shadow-2xl">
            <div className="relative max-w-5xl mx-auto text-center">
              <Skeleton className="h-12 w-3/4 mx-auto mb-8 animate-pulse" />
              <Skeleton className="h-6 w-full mx-auto mb-12 animate-pulse" />
              <Skeleton className="h-10 w-48 mx-auto animate-pulse" />
            </div>
          </section>
        ) : (
          <section className="px-6 py-24 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 relative overflow-hidden rounded-t-3xl shadow-2xl">
